            ...
            <div className="row">
                ...
                <div className="col-sm-6 col-md-6 form-section mt-5">
                    <div className="login-wrapper">
                        <h2 className="login-title tittlelogin"><u> Sign Up </u></h2>
                        <form onSubmit={handleSubmit}>
                            {error && <div className="alert alert-danger">{error}</div>}
                            <div className="input-group">
                                <input
                                    type="text" name="first" id="first" className="form-control" placeholder="First Name"
                                    value={firstName} onChange={(e) => setFirstName(e.target.value)} />
                                <input
                                    type="text" name="last" id="last" className="form-control" placeholder="Last Name"
